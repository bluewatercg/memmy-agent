...
async function* readConversationMessages(db: Database.Database): AsyncIterable<RawOpenclawMessage> {
...
async function* readMemoryChunks(db: Database.Database): AsyncIterable<RawOpenclawMessage> {
...
function getTableColumns(db: Database.Database, tableName: string): ReadonlySet<string> {
